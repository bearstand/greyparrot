/* 
 * This code is copied from https://code.launchpad.net/~binwiederhier/+junk/android-service-example
 * It makes communicating between activity and service much easier.
 * This is the blog: http://blog.philippheckel.com/2012/06/10/android-example-communication-between-activity-and-service-using-messaging/
 */
...
public class ServiceManager {
	...
	private void doStartService(String key, String value) {
